...
import { BoldTextProp, TutorialProp } from "./types";

const Tutorial = ({ clickedBrowser }: TutorialProp) => {
  return (
    <div className="tutorial-container">
      ...
      {[<Chrome />, <Safari />, <Edge />, <Firefox />][clickedBrowser]}
...
const BoldText = ({ children }: BoldTextProp) => (
