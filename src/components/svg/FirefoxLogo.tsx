import { LogoProps } from "./ChromeLogo";
    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset=".508" stopColor="#ff9640" stopOpacity="0" />
        </linearGradient>
        <radialGradient
          id="gg"
          cx="-1255.933"
      ...
      />
      <path
        d="M75.651 30.935a41.01 41.01 0 0 1 .3 7.247q1.99-.3 3.987-.53A40.01 40.01 0 0 0 71.944 15.7 39.47 39.47 0 0 0 41.588.009C32.3-.177 25.884 2.614 22.254 4.858 27.111 2.041 34.14.443 40.294.522 56.124.724 73.126 11.5 75.651 30.935z"
        fill="url(#ff)"
      />
      <path
